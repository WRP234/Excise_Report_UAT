...
{
    public partial class ILG60_00_05_003 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60_00_05_003";
                string para = "ProveID";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_05_001Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.ProveID > 0)
                            {
                                ...
                                rpt.SetParameterValue(para, js.ProveID.ToString());
