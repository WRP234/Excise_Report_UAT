...
namespace Report_XCS
{
    ...
    public partial class ILG60_00_03_001 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-03-001";
                string para = "ArrestCode";
                try
                {
                    ...
                    if (requestFromPost != null)
                    {
                        ...
                        if (js != null)
                        {
                            if (js.ArrestCode != "")
                            {
                                ...
                                rpt = new cryslogin().Getsublogin(rpt);
                                rpt.SetParameterValue(para, js.ArrestCode.ToString());
