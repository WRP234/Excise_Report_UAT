...
{
    public partial class ILG60_00_06_005 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-06-005";
                ...
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_06_005Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.CompareID > 0)
                            {
