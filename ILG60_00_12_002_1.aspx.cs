...
{
    public partial class ILG60_00_12_002_1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-12-002-1";
                ...
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_12_002_1Json>(requestFromPost);
                        if (js != null)
                        {
