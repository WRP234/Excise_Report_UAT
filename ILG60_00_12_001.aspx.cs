...
{
    public partial class ILG60_00_12_001 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-12-001";
                ...
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_12_001Json>(requestFromPost);
                        if (js != null)
                        {
