...
{
    public partial class ILG60_00_09_002 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-09-002";
                ...
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_09_002Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.LawsuitID > 0)
                            {
