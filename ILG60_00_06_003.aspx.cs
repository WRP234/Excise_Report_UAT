...
namespace Report_XCS
{
    ...
    public partial class ILG60_00_06_003 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-06-003";
                ...
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ComparegetByConJson>(requestFromPost);
                        if (js != null)
                        {
                            if (js.CompareID >0)
                            {
