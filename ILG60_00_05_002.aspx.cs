...
namespace Report_XCS
{
    ...
    public partial class ILG60_00_05_002 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-05-002";
                string para = "ProveID";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ProvegetByConModel>(requestFromPost);
                        if (js != null)
                        {
                            if (js.ProveID != "")
                            {
