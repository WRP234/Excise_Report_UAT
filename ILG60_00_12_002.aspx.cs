...
{
    public partial class ILG60_00_12_002 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-12-002";
                string para1 = "startdate";
                string para2 = "enddate";
                string para3 = "officecode";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_12_002Json>(requestFromPost);
                        if (js != null)
                        {
                            ...
                            rpt.SetParameterValue(para3, js.officecode.ToString());
                        ...
                        else
                        {
                            ...
                            Response.Write("OfficeCode1 : " + js.officecode.ToString() + "  ");
                            Response.End();
                        }
