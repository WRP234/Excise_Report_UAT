...
namespace Report_XCS
{
    ...
    public partial class ILG60_00_04_001 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-04-001";
                string para = "LawsuitID";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_06_004Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.LawsuitID > 0)
                            {
                                ...
                                rpt.SetParameterValue(para, js.LawsuitID.ToString());
