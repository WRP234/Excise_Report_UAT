...
namespace Report_XCS
{
    ...
    public partial class ILG60_00_08_002 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-08-002";
                string para = "RequestBribeID";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_08_001Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.RequestBribeID > 0)
                            {
