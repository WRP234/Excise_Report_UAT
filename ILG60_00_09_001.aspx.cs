...
{
    public partial class ILG60_00_09_001 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string filename = "ILG60-00-09-001";
                string para = "CompareID";
                try
                {
                    ...
                    {
                        var js = JsonConvert.DeserializeObject<ILG60_00_09_001Json>(requestFromPost);
                        if (js != null)
                        {
                            if (js.CompareID > 0)
                            {
                                ...
                                rpt.SetParameterValue(para, js.CompareID.ToString());
                            ...
                            else
                            {
                                ...
                                Response.Write("CompareID : " + js.CompareID.ToString() + "  ");
                                Response.End();
                            }
                        }
                    }
